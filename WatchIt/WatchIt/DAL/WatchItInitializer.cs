        ...
        protected override void Seed(WatchItContext context)
        {
            ...
            var movies = new List<Movie>
            {
                new Movie { ID = 1, Title = "The Lion King", Description = "After the murder of his father, a young lion prince flees his kingdom only to learn the true meaning of responsibility and bravery.",
                    ...
                    Price =10, Length=118, Rating=7.2, DirectorID=1, ReleaseDate = DateTime.Parse("2019-07-18 08:00:00"),
                ...
                new Movie { ID = 2, Title = "The Dark Knight", Description = "When the menace known as the Joker emerges from his mysterious past, he wreaks havoc and chaos on the people of Gotham. The Dark Knight must accept one of the greatest psychological and physical tests of his ability to fight injustice.",
                    ...
                    Price =13, Length=140, Rating=9.0, DirectorID=2, ReleaseDate = DateTime.Parse("2015-10-06 08:00:00"),
                ...
                new Movie { ID = 3, Title = "Fast And Furious: Hobbs And Shaw", Description = "Lawman Luke Hobbs and outcast Deckard Shaw form an unlikely alliance when a cyber-genetically enhanced villain threatens the future of humanity.",
                    ...
                    Price =11, Length=135, Rating=7.3, DirectorID=3, ReleaseDate = DateTime.Parse("2019-08-01 08:00:00"),
                ...
                new Movie { ID = 4, Title ="Annabelle Comes Home" ,Description = "While babysitting the daughter of Ed and Lorraine Warren, a teenager and her friend unknowingly awaken an evil spirit trapped in a doll.",
                    ...
                    Price =12, Length=110, Rating=6.2, DirectorID = 2 , ReleaseDate = DateTime.Parse("2019-07-11 08:00:00"),
                ...
                new Movie { ID = 5, Title ="Stuber" ,Description = "A detective recruits his Uber driver into an unexpected night of adventure.",
                    ...
                    Price =15, Length=105, Rating=6.2, DirectorID = 2 , ReleaseDate = DateTime.Parse("2019-07-11 08:00:00"),
                ...
                new Movie { ID = 6, Title ="Escape Plan: The Extractors" ,Description = "After security expert Ray Breslin is hired to rescue the kidnapped daughter of a Hong Kong tech mogul from a formidable Latvian prison, Breslin's girlfriend is also captured.",
                    ...
                    Price =18, Length=97, Rating=4.5, DirectorID = 2 , ReleaseDate = DateTime.Parse("2019-07-04 08:00:00"),
                ...
                new Movie { ID = 7, Title ="Spider-Man Far From Home" ,Description = "Following the events of Avengers: Endgame (2019), Spider-Man must step up to take on new threats in a world that has changed forever.",
                    ...
                    Price =11, Length=130, Rating=7.9, DirectorID = 2 , ReleaseDate = DateTime.Parse("2019-07-04 08:00:00"),
                ...
                new Movie { ID = 8, Title ="Late Night" ,Description = "A late night talk show host suspects that she may soon lose her long-running show.",
                    ...
                    Price =18, Length=100, Rating=6.5, DirectorID = 2 , ReleaseDate = DateTime.Parse("2019-06-27 08:00:00"),
                ...
                new Movie { ID = 9, Title ="Toy Story 4" ,Description = "When a new toy called 'Forky' joins Woody and the gang, a road trip alongside old and new friends reveals how big the world can be for a toy.",
                    ...
                    Price =18, Length=100, Rating=8.2, DirectorID = 2 , ReleaseDate = DateTime.Parse("2019-06-20 08:00:00"),
                ...
                new Movie { ID = 10, Title ="Aladdin" ,Description = "A kind-hearted street urchin and a power-hungry Grand Vizier vie for a magic lamp that has the power to make their deepest wishes come true.",
                    ...
                    Price =24, Length=129, Rating=7.4, DirectorID = 2 , ReleaseDate = DateTime.Parse("2018-05-23 08:00:00"),
                ...
                new Movie { ID = 11, Title ="Avenger EndGame" ,Description = "After the devastating events of Avengers: Infinity War (2018), the universe is in ruins. With the help of remaining allies, the Avengers assemble once more in order to reverse Thanos' actions and restore balance to the universe.",
                    ...
                    Price =29, Length=189, Rating=8.7, DirectorID = 3 , ReleaseDate = DateTime.Parse("2018-04-25 08:00:00"),
                ...
                new Movie { ID = 12, Title ="The Conjuring 2" ,Description = "Ed and Lorraine Warren travel to North London to help a single mother raising 4 children alone in a house plagued by a supernatural spirit.",
                    ...
                    Price =19, Length=134, Rating=7.7, DirectorID = 3 , ReleaseDate = DateTime.Parse("2016-06-10 08:00:00"),
                ...
                new Movie { ID = 14, Title ="Titanic" ,Description = "A seventeen-year-old aristocrat falls in love with a kind but poor artist aboard the luxurious, ill-fated R.M.S. Titanic.",
                    ...
                    Price =21, Length=194, Rating=7.8, DirectorID = 3 , ReleaseDate = DateTime.Parse("1997-12-19 08:00:00"),
                ...
                new Movie { ID = 15, Title ="Get Out" ,Description = "A young African-American visits his white girlfriend's parents for the weekend, where his simmering uneasiness about their reception of him eventually reaches a boiling point.",
                    ...
                    Price =16, Length=104, Rating=7.7, DirectorID = 3 , ReleaseDate = DateTime.Parse("2017-02-24 08:00:00"),
                ...
                new Movie { ID = 16, Title ="The Godfather" ,Description = "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.",
                    ...
                    Price =23, Length=174, Rating=9.2, DirectorID = 3 , ReleaseDate = DateTime.Parse("1972-03-24 08:00:00"),
                ...
                new Movie { ID = 17, Title ="Now You See Me 2" ,Description = "The Four Horsemen resurface, and are forcibly recruited by a tech genius to pull off their most impossible heist yet.",
                    ...
                    Price =16, Length=129, Rating=6.5, DirectorID = 3 , ReleaseDate = DateTime.Parse("2016-06-10 08:00:00"),
                ...
                new Movie { ID = 18, Title ="Sherlock Holmes" ,Description = "Detective Sherlock Holmes and his stalwart partner Watson engage in a battle of wits and brawn with a nemesis whose plot is a threat to all of England.",
                    ...
                    Price =12, Length=128, Rating=6.5, DirectorID = 3 , ReleaseDate = DateTime.Parse("2009-09-25 08:00:00"),
                ...
                new Movie { ID = 19, Title ="Shutter Island" ,Description = "In 1954, a U.S. Marshal investigates the disappearance of a murderer, who escaped from a hospital for the criminally insane.",
                    ...
                    Price =18, Length=138, Rating=8.1, DirectorID = 4 , ReleaseDate = DateTime.Parse("2010-02-19 08:00:00"),
                ...
                new Movie { ID = 20, Title ="Heat" ,Description = "A group of professional bank robbers start to feel the heat from police when they unknowingly leave a clue at their latest heist.",
                    ...
                    Price =22, Length=170, Rating=8.2, DirectorID = 4 , ReleaseDate = DateTime.Parse("1995-12-15 08:00:00"),
            ...
            {
                  new Order { OrderID = 2, CustomerId = customers.Single(s => s.FirstName == "Zach").CustomerID,   OrderDate = DateTime.Parse("2019-01-11 16:58:51"), BranchID = branches.Single(b => b.BranchID == 1).BranchID, Movies = {  movies.Single(m => m.ID == 1), movies.Single(m => m.ID == 2) } },
                  new Order { OrderID = 3, CustomerId = customers.Single(s => s.FirstName == "Zach").CustomerID,   OrderDate = DateTime.Parse("2019-01-06 10:51:14"), BranchID = branches.Single(b => b.BranchID == 1).BranchID, Movies = {  movies.Single(m => m.ID == 3) } },               
                  new Order { OrderID = 4, CustomerId = customers.Single(s => s.FirstName == "Zach").CustomerID,   OrderDate = DateTime.Parse("2019-02-06 12:13:55"), BranchID = branches.Single(b => b.BranchID == 1).BranchID, Movies = {  movies.Single(m => m.ID == 5), movies.Single(m => m.ID == 13) } },
                  new Order { OrderID = 5, CustomerId = customers.Single(s => s.FirstName == "Tahel").CustomerID,  OrderDate = DateTime.Parse("2019-04-16 05:59:34"), BranchID = branches.Single(b => b.BranchID == 1).BranchID, Movies = {  movies.Single(m => m.ID == 14), movies.Single(m => m.ID == 12) } },
                  new Order { OrderID = 6, CustomerId = customers.Single(s => s.FirstName == "Yarden").CustomerID, OrderDate = DateTime.Parse("2019-07-01 08:35:15"), BranchID = branches.Single(b => b.BranchID == 2).BranchID, Movies = {  movies.Single(m => m.ID == 17), movies.Single(m => m.ID == 20) } },
                  new Order { OrderID = 7, CustomerId = customers.Single(s => s.FirstName == "Yarden").CustomerID, OrderDate = DateTime.Parse("2019-10-11 09:44:18"), BranchID = branches.Single(b => b.BranchID == 2).BranchID, Movies = {  movies.Single(m => m.ID == 9)} },
                  new Order { OrderID = 8, CustomerId = customers.Single(s => s.FirstName == "Loren").CustomerID,  OrderDate = DateTime.Parse("2019-10-21 19:41:39"), BranchID = branches.Single(b => b.BranchID == 3).BranchID, Movies = {  movies.Single(m => m.ID == 10)} },
                  new Order { OrderID = 9, CustomerId = customers.Single(s => s.FirstName == "Loren").CustomerID,  OrderDate = DateTime.Parse("2019-10-30 21:53:30"), BranchID = branches.Single(b => b.BranchID == 3).BranchID, Movies = {  movies.Single(m => m.ID == 19)} },
                  new Order { OrderID = 10,CustomerId = customers.Single(s => s.FirstName == "Loren").CustomerID,  OrderDate = DateTime.Parse("2019-10-01 23:18:47"), BranchID = branches.Single(b => b.BranchID == 3).BranchID, Movies = {  movies.Single(m => m.ID == 16), movies.Single(m => m.ID == 6) } }
            };
